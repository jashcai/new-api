...
export const STATIC_I18N_KEYS = [
  ...
  'Private AI gateway for internal teams',
  'One governed gateway for',
  ...
  'Policy control',
  'Groups, models, and quotas',
  'Key custody',
  'Provider secrets stay internal',
  'Live operations',
  'Usage, errors, and cost',
  'Model governance',
  ...
  'Reliable routing',
  'Balance traffic across channels with retry, rate limits, and health-aware routing',
  'Fallback Routing',
  'Developer ready',
  'Expose compatible API routes so internal apps can migrate without bespoke SDK work',
  'Enterprise control plane',
  'Govern access,',
  'operate with confidence',
  'Operational visibility',
  'Monitor latency, errors, token usage, and channel health',
  'Cost control',
  'Track usage and enforce quotas before spend drifts',
  'Team administration',
  'Manage users, groups, roles, and enterprise sign-in',
  'Audit readiness',
  'Preserve action and usage trails for internal reviews',
  'upstream providers unified',
  'models governed by policy',
  'compatible enterprise routes',
  ...
  'Operate safely',
  'Review usage, costs, audit logs, errors, and routing performance in one console',
  'Deployment workflow',
  'From provider sprawl to governed access',
  'Give every team one controlled',
  'AI access layer',
